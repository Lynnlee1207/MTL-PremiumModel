...
class MTNN(nn.Module):
    def __init__(self, shared_encoder_params, freq_decoder_params, sev_decoder_params):
        super().__init__()
        ...
        self.sev_decoder = MLP(**sev_decoder_params, output_dim=2, final_activation=nn.Softplus())  # type: ignore
    ...
    def forward(self, X):
        ...
        sev_out = self.sev_decoder(shared_features)
        return freq_out, sev_out


class MTNNPremiumModel(PremiumModel):
    ...
    def __init__(
        ...
        self.sev_decoder_params = sev_decoder_params
    ...
    def _fit(self, X_freq, y_freq, w_freq, X_sev, y_sev, w_sev):
        ...
        self.sev_decoder_params["input_dim"] = hidden_dim
        self.model = MTNN(self.shared_encoder_params, self.freq_decoder_params, self.sev_decoder_params).to(self.device)
        ...
        torch.save(
            {
                ...
                "sev_decoder_params": self.sev_decoder_params,
    ...
    def _load(cls, path: str):
        ...
        self = cls(
            ...
            sev_decoder_params=checkpoint["sev_decoder_params"],
